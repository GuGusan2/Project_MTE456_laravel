            ...
            <div class="card-body p-4">
                ...
                <form action="/member/{{ $mem_id }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-start mb-3">
                            <div class="card shadow-sm p-3 position-relative"
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    {{-- แสดงรูปปัจจุบัน --}}
                                    <img id="previewImage" src="{{ asset('storage/' . $mem_pic) }}" alt="Member Picture"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-lg-6 col-sm-12">
                            ...
                            <input type="email" class="form-control" name="mem_email" required
                                placeholder="email/username" value="{{ $mem_email }}">
                        ...
                        <div class="mb-3 col-md-6 col-lg-6 col-sm-12">
                            ...
                            <input type="tel" class="form-control" name="mem_phone" required
                                placeholder="Phone 10 digit" minlength="10" maxlength="10" value="{{ $mem_phone }}">
                    ...
                    <div class="text-end">
                        ...
                        <a href="/member" class="btn btn-cancle btn-danger ms-2 mb-2">
