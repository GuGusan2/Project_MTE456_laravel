            ...
            <div class="card-body p-4">
                <form action="{{ url('/member') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-lg-6 col-sm-12">
                            ...
                            <input type="email" class="form-control" name="mem_email" required
                                placeholder="email address" minlength="3" value="{{ old('mem_email') }}">
                            @error('mem_email')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-lg-6 col-sm-12">
                            ...
                            <input type="tel" class="form-control" name="mem_phone" required
                                placeholder="Phone 10 digit" minlength="10" maxlength="10" value="{{ old('mem_phone') }}">
                            @error('mem_phone')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-lg-6 col-sm-12">
                            ...
                            <input type="date" class="form-control" name="mem_dob" required
                                value="{{ old('mem_dob') }}">
                            @error('mem_dob')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="text-end">
                        ...
                        <a href="{{ url('/member') }}" class="ms-2 mb-2 btn btn-cancle btn-secondary">
