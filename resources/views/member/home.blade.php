    ...
    <div id="bannerCarousel" class="carousel slide mb-5 shadow rounded" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner rounded">
            <div class="carousel-item active">
                <img src="{{ asset('images/banner.png') }}" class="d-block w-100 rounded" alt="Banner 1">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('images/banner.png') }}" class="d-block w-100 rounded" alt="Banner 2">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('images/banner.png') }}" class="d-block w-100 rounded" alt="Banner 3">
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow border-0 rounded-3 menu-card">
                    <img src="{{ asset('storage/' . $menu->menu_pic) }}" 
                         class="card-img-top menu-img rounded-top"
                         alt="{{ $menu->menu_name }}">
            ...
            @foreach($promotions as $promo)
                <div class="col-md-4">
                    <div class="card h-100 shadow border-0 rounded-3">
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-bold text-danger">โปรโมชั่น #{{ $promo->pro_id }}</h5>
                            <p class="card-text"><strong>รายละเอียด:</strong> {{ $promo->detail }}</p>
                            <p class="card-text"><strong>เงื่อนไข:</strong> {{ $promo->conditions }}</p>
