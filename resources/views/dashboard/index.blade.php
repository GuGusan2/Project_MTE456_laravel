...
<div class="container-fluid mt-4">
    ...
    <div class="row g-4 mb-4">
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-custom shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-box bg-primary me-3"><i class="fa-solid fa-users"></i></div>
                    <div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-custom shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-box bg-success me-3"><i class="fa-solid fa-briefcase"></i></div>
                    <div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-custom shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-box bg-warning me-3"><i class="fa-solid fa-utensils"></i></div>
                    <div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-custom shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-box bg-danger me-3"><i class="fa-solid fa-tags"></i></div>
                    <div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-custom shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-box bg-info me-3"><i class="fa-solid fa-archive"></i></div>
                    <div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-custom shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="icon-box bg-secondary me-3"><i class="fa-solid fa-eye"></i></div>
                    <div>
...
<script>
    ...
    // Visits Chart
    new Chart(document.getElementById('visitsChart2'), {
        type: 'line',
        data: {
