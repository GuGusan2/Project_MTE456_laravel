                        ...
                        @foreach ($employees as $row)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="{{ asset('storage/' . $row->emp_pic) }}" width="70"
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-danger btn-sm"
                                        onclick="deleteConfirm({{ $row->emp_id }})">
                                        🗑 Delete
                                    </button>
                                    <form id="delete-form-{{ $row->emp_id }}"
                                        action="/employee/remove/{{ $row->emp_id }}" method="POST" class="d-none">
                                        @csrf
                                        @method('delete')
                                    </form>
                                </td>
