            ...
            <form action="/employee/{{ $emp_id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="emp_email" required
                           placeholder="email/username" value="{{ $emp_email }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="emp_username" required
                           placeholder="Username" value="{{ $emp_username }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" name="emp_phone" required
                           placeholder="Phone 10 digit" minlength="10" maxlength="10"
                           value="{{ $emp_phone }}">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="emp_gender" id="male" value="male"
                                   {{ $emp_gender == 'male' ? 'checked' : '' }}>
                            <label class="form-check-label" for="male">Male</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="emp_gender" id="female" value="female"
                ...
                <div class="mb-3">
                    ...
                    <div>
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="role" id="staff" value="staff"
                                   {{ $role == 'staff' ? 'checked' : '' }}>
